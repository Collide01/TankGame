...
[CustomEditor(typeof(AISmart)), CanEditMultipleObjects]
public class AISmartEditor : Editor
{
    private void OnSceneGUI()
    {
        ...
        if (aiTank.currentState == AIController.AIState.GoToSpot)
        {
            Handles.color = Color.red;
            Handles.DrawWireArc(aiTank.heardPosition, Vector3.up, Vector3.forward, 360, 2);
        }
    }
